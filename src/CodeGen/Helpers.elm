                ...
                case imps of
                    ...
                    h :: t ->
                        if moduleName == h.moduleName then
                            ...
                            helper t
        in
        helper (imports ++ basicImports)


basicImports : List ExistingImport
basicImports =
    ...
    , { moduleName = [ "Result" ], moduleAlias = Nothing, exposingList = Explicit [ node (TypeExpose { name = "Maybe", open = Just Elm.Syntax.Range.emptyRange }) ] }
